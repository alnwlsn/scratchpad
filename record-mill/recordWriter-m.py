...
# version for making material for the video
...
samplerate, data = wavfile.read('posthorn-short.wav')
...
ax = plt.gca()
linedata, = ax.plot(x, y,color="red")
ax.set_aspect('equal')
...
plt.savefig('images/record-circle.png', dpi=100)
